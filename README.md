...
|-------------|-----------------|------------------------|------------------------|-----------------|  
| ![GPO](https://github.com/diegomtz28/Active-Directory-Lab/blob/main/docs/images/Group%20policy%20Creation.png) | ![PassPolicy](https://github.com/diegomtz28/Active-Directory-Lab/blob/main/docs/images/Password%20Policy%20Enforced.png) | ![Lockout](screenshots/security/account-lockout.png) | ![GuestDisabled](screenshots/security/guest-disabled.png) | ![Gpupdate](screenshots/security/gpupdate.png) |  
